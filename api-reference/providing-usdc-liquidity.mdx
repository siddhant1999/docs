...
## Creating an Exclusive Seller Network

Integrators can create exclusive networks of sellers specifically for their users, ensuring better control over liquidity and user experience.
...
### Step 2: Configure Seller Exclusivity
Sellers in your network can control their matching preferences from the seller dashboard:

- **Exclusivity Toggle ON**: Seller only matches with your users/buyers
- **Exclusivity Toggle OFF**: Seller matches with both your users and public buy orders
...
### Exclusive Network Requirements

For complete exclusivity between your sellers and buyers:

1. **Seller Configuration**: Sellers must set their status to "exclusively listed" on the dashboard
...
<Warning>
  Both conditions must be met for exclusive matching. If either is missing, your buyers may be matched with public sellers as well.
</Warning>

## Benefits of Exclusive Networks
...
- **Performance Tracking**: Monitor transaction success rates and seller bank reliability
...
For assistance with seller onboarding and exclusive networks:
...
<Note>
  We're committed to helping integrators build successful USDC onramp experiences. Contact us to discuss your specific liquidity needs and get started with your exclusive seller network.
</Note> 