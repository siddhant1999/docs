...
<Note>
  **API Key Required**
  ...
  To use Phoenix payments, you'll need an API key. You can request one by:
  - Emailing us at main@phoenix.market
  - Including your company name and intended use case
  - We'll respond within 1 business day with your API key and additional integration support
</Note>
