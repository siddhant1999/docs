...
<div style={{ marginTop: '24px', marginBottom: '24px' }}>
  <CardGroup>
    <a href="https://app-partner.phoenix.market/public/download-phoenix-native.html" download style={{ textDecoration: 'none', minWidth: '400px', display: 'block' }} target="_blank" rel="noopener noreferrer">
