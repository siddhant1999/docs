...
<AccordionGroup>
  <Accordion title="View Component Code">
    ...
    export const PhoenixPaymentNative: React.FC<PhoenixPaymentNativeProps> = ({
      ...
      const getWebViewUrl = () => {
        return `https://app-partner.phoenix.market/?address=${walletAddress}&amount=${amount}&access_token=${accessToken}`;
      };
...
### Step 4.4: Handle Payment Completion
