...
<Tabs>
  ...
  <Tab title="Manual Zelle Payment">
    ...
    <Note className="mt-4">
      For security and transaction verification, we add a unique random number of cents (between \$0.00 and \$0.20) to each transaction amount. This helps us match and verify your specific payment among all incoming Zelle transactions.
    </Note>
  </Tab>
</Tabs>
